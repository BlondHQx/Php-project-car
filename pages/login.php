...
<body class="img js-fullheight" style="background-image: url('https://cdn.wallpapersafari.com/22/27/vJNp6z.jpg'); height: 710px;">
  <header class="w-100">
  ...
  <main>
    ...
    <div class="wrapper">
        ...
        <p>You dont have account :</p><a href="./register.php">Sign up</a>
        </div>
    </div>
  </main>
